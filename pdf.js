...
! function webpackUniversalModuleDefinition(t, e) {
    ...
    var __webpack_modules__ = [, (t, e) => {
            ...
            e.UnexpectedResponseException = class UnexpectedResponseException extends n {
                constructor(t, e) {
            ...
            class Util {
                ...
                static bezierBoundingBox(t, e, s, i, n, a, r, o) {
                    ...
                    for (; _--;) {
                        p = l[_];
                        A = 1 - p;
                        c[0][_] = A * A * A * t + 3 * A * A * p * s + 3 * A * p * p * n + p * p * p * r;
                        c[1][_] = A * A * A * e + 3 * A * A * p * i + 3 * A * p * p * a + p * p * p * o
                    }
                    c[0][y] = t;
                    c[1][y] = e;
                    c[0][y + 1] = r;
            ...
            if (_is_node.isNodeJS) {
                ...
                createPDFNetworkStream = s => (0, _display_utils.isValidFetchUrl)(s.url) ? new e(s) : new t(s)
            }
            ...
            function getDocument(t) {
                ...
                const d = t.verbosity,
                    ...
                    v = "boolean" == typeof t.isOffscreenCanvasSupported ? t.isOffscreenCanvasSupported : !_is_node.isNodeJS,
                    ...
                    R = "boolean" == typeof t.useSystemFonts ? t.useSystemFonts : !_is_node.isNodeJS && !x,
                    D = "boolean" == typeof t.useWorkerFetch ? t.useWorkerFetch : g === _display_utils.DOMCMapReaderFactory && b === _display_utils.DOMStandardFontDataFactory && (0, _display_utils.isValidFetchUrl)(p, document.baseURI) && (0, _display_utils.isValidFetchUrl)(m, document.baseURI),
            ...
            class PDFPageProxy {
                ...
                render({
                    ...
                    if (arguments[0]?.canvasFactory) throw new Error("render no longer accepts the `canvasFactory`-option, please pass it to the `getDocument`-function instead.");
                    ...
                    const pump = () => {
                        i.read().then((({
                            ...
                            if (!this._transport.destroyed) {
                                ...
                                if (n.displayReadyCapability) n.displayReadyCapability.reject(t);
                                else {
            ...
            class LoopbackPort {
                ...
                postMessage(t, e) {
                    ...
                    this.#r.then((() => {
                        for (const t of this.#a) t.call(this, s)
                    }))
                }
            ...
            class PDFWorker {
                ...
                constructor({
                    ...
                    if (e && PDFWorker.#o.has(e)) throw new Error("Cannot use more than one PDFWorker per port.");
                    this.name = t;
                    this.destroyed = !1;
                    this.verbosity = s;
                    this._readyCapability = (0, _util.createPromiseCapability)();
                ...
                static fromPort(t) {
                    ...
                    return this.#o.has(t.port) ? this.#o.get(t.port) : new PDFWorker(t)
                }
            ...
            class WorkerTransport {
                ...
                getRenderingIntent(t, e = _util.AnnotationMode.ENABLE, s = null, i = !1) {
                    ...
                    return {
                        renderingIntent: n,
                        cacheKey: `${n}_${_annotation_storage.AnnotationStorage.getHash(a)}`,
                ...
                getFieldObjects() {
                    return this.#d("GetFieldObjects")
                }
                hasJSActions() {
                    return this.#d("HasJSActions")
                }
                getCalculationOrderIds() {
            ...
            class InternalRenderTask {
                ...
                constructor({
                    ...
                    this._useRequestAnimationFrame = !0 === c && "undefined" != typeof window;
                    this.cancelled = !1;
                ...
                initializeGraphics({
                    ...
                    if (this._canvas) {
                        if (InternalRenderTask.#g.has(this._canvas)) throw new Error("Cannot use the same canvas during multiple render() operations. Use different canvas or ensure previous operations were cancelled or completed.");
                        InternalRenderTask.#g.add(this._canvas)
                    }
                ...
                cancel(t = null, e = 0) {
                    ...
                    this._canvas && InternalRenderTask.#g.delete(this._canvas);
            ...
            class AnnotationStorage {
                ...
                remove(t) {
                    this.#b.delete(t);
                    0 === this.#b.size && this.resetModified();
                ...
                getAll() {
                    return this.#b.size > 0 ? (0, i.objectFromMap)(this.#b) : null
                }
                setAll(t) {
            ...
            class PrintAnnotationStorage extends AnnotationStorage {
                ...
                constructor(t) {
                    super();
                    this.#_ = structuredClone(t.serializable)
                }
                get print() {
            ...
            class AnnotationEditor {
                ...
                #v = this.focusout.bind(this);
                #S = !1;
                #x = !1;
                #E = !1;
                _uiManager = null;
                #C = AnnotationEditor._zIndex++;
                ...
                focusin(t) {
                    this.#S ? this.#S = !1 : this.parent.setSelected(this)
                }
                focusout(t) {
                ...
                render() {
                    ...
                    this.div.addEventListener("focusout", this.#v);
                ...
                getRect(t, e) {
                    ...
                    switch (this.rotation) {
                        case 0:
                            return [c + o + a, n - h - l - u + r, c + o + d + a, n - h - l + r];
                        case 90:
                            return [c + l + a, n - h + o + r, c + l + u + a, n - h + o + d + r];
                        case 180:
                            return [c - o - d + a, n - h + l + r, c - o + a, n - h + l + u + r];
                        case 270:
                            return [c - l - u + a, n - h - o - d + r, c - l + a, n - h - o + r];
                        default:
                ...
                static deserialize(t, e, s) {
                    ...
                    const [n, a] = i.pageDimensions, [r, o, l, c] = i.getRectInCurrentCoords(t.rect, a);
                    i.x = r / n;
                    i.y = o / a;
                    i.width = l / n;
                    i.height = c / a;
                ...
                remove() {
                    ...
                    this.div.removeEventListener("focusout", this.#v);
            ...
            class KeyboardManager {
                ...
                exec(t, e) {
                    ...
                    const s = this.callbacks.get(this.#M(e));
                    if (s) {
                        s.bind(t)();
                        e.stopPropagation();
                        e.preventDefault()
            ...
            class AnnotationEditorUIManager {
                ...
                #V = this.cut.bind(this);
                #X = this.paste.bind(this);
                #$ = this.keydown.bind(this);
                #K = this.onEditingAction.bind(this);
                #Y = this.onPageChanging.bind(this);
                #J = this.onScaleChanging.bind(this);
                #Q = this.onRotationChanging.bind(this);
                #Z = {
                    isEditing: !1,
                    isEmpty: !0,
                ...
                constructor(t, e, s) {
                    this.#tt = t;
                    this.#U = e;
                    this.#U._on("editingaction", this.#K);
                    this.#U._on("pagechanging", this.#Y);
                    this.#U._on("scalechanging", this.#J);
                    this.#U._on("rotationchanging", this.#Q);
                    this.#O = s;
                    this.viewParameters = {
                ...
                destroy() {
                    this.#et();
                    this.#U._off("editingaction", this.#K);
                    this.#U._off("pagechanging", this.#Y);
                    this.#U._off("scalechanging", this.#J);
                    this.#U._off("rotationchanging", this.#Q);
                ...
                #st() {
                    this.#tt.addEventListener("keydown", this.#$)
                }
                #et() {
                    this.#tt.removeEventListener("keydown", this.#$)
                }
                #it() {
                    document.addEventListener("copy", this.#z);
                    document.addEventListener("cut", this.#V);
                    document.addEventListener("paste", this.#X)
                }
                #nt() {
                    document.removeEventListener("copy", this.#z);
                    document.removeEventListener("cut", this.#V);
                    document.removeEventListener("paste", this.#X)
                }
                copy(t) {
                    t.preventDefault();
                    ...
                    const e = [];
                    for (const t of this.#H) t.isEmpty() || e.push(t.serialize());
                ...
                #ot(t) {
                    Object.entries(t).some((([t, e]) => this.#Z[t] !== e)) && this.#U.dispatch("annotationeditorstateschanged", {
                        source: this,
                        details: Object.assign(this.#Z, t)
                    })
                }
                #lt(t) {
                    this.#U.dispatch("annotationeditorparamschanged", {
                        source: this,
                        details: t
                    })
                }
                ...
                registerEditorTypes(t) {
                    if (!this.#B) {
                        this.#B = t;
                        for (const t of this.#B) this.#lt(t.defaultPropertiesToUpdate)
                    }
                }
                getId() {
                    return this.#q.getId()
                ...
                updateToolbar(t) {
                    t !== this.#G && this.#U.dispatch("switchannotationeditormode", {
                        source: this,
                        mode: t
                    })
                }
                updateParams(t, e) {
                    if (this.#B) {
                        for (const s of this.#H) s.updateParams(t, e);
                ...
                getEditors(t) {
                    const e = [];
                    for (const s of this.#D.values()) s.pageIndex === t && e.push(s);
                    return e
                }
                getEditor(t) {
                    return this.#D.get(t)
                ...
                setSelected(t) {
                    for (const e of this.#H) e !== t && e.unselect();
                    this.#H.clear();
                    this.#H.add(t);
                    t.select();
                    this.#lt(t.propertiesToUpdate);
                ...
                selectAll() {
                    for (const t of this.#H) t.commit();
                    this.#rt(this.#D.values())
                }
                unselectAll() {
                    if (this.#R) this.#R.commitOrRemove();
                    else if (0 !== this.#H.size) {
                        for (const t of this.#H) t.unselect();
                        this.#H.clear();
                        this.#ot({
                            hasSelectedEditor: !1
                        })
            ...
            e.setLayerDimensions = function setLayerDimensions(t, e, s = !1, i = !0) {
            ...
            class DOMFilterFactory extends i.BaseFilterFactory {
                ...
                get #_t() {
                    if (!this.#pt) {
                        ...
                        this.#pt = this.#ft.createElementNS(a, "defs");
                        t.append(s);
                        s.append(this.#pt);
                        this.#ft.body.append(t)
                    }
                    return this.#pt
                }
                #yt(t, e, s) {
                ...
                addFilter(t) {
                    ...
                    if (1 === t.length) {
                        ...
                        const [a, r, o] = t, l = new Array(256), c = new Array(256), h = new Array(256);
                        for (let t = 0; t < 256; t++) {
                            l[t] = a[t] / 255;
                            c[t] = r[t] / 255;
                            h[t] = o[t] / 255
                    ...
                    const o = `g_${this.#t}_transfer_map_${this.#P++}`,
                        l = `url(#${o})`;
                    this.#At.set(t, l);
                    this.#At.set(n, l);
                    const c = this.#ft.createElementNS(a, "filter", a);
                    c.setAttribute("id", o);
                    c.setAttribute("color-interpolation-filters", "sRGB");
                    const h = this.#ft.createElementNS(a, "feComponentTransfer");
                    c.append(h);
                    this.#yt(h, "feFuncR", e);
                    this.#yt(h, "feFuncG", s);
                    this.#yt(h, "feFuncB", i);
                ...
                addHCMFilter(t, e) {
                    const s = `${t}-${e}`;
                    if (this.#mt === s) return this.#bt;
                    this.#mt = s;
                    this.#bt = "none";
                    this.#gt?.remove();
                    if (!t || !e) return this.#bt;
                    this.#_t.style.color = t;
                    const i = getRGB(t = getComputedStyle(this.#_t).getPropertyValue("color"));
                    t = n.Util.makeHexColor(...i);
                    this.#_t.style.color = e;
                    const r = getRGB(e = getComputedStyle(this.#_t).getPropertyValue("color"));
                    e = n.Util.makeHexColor(...r);
                    this.#_t.style.color = "";
                    if ("#000000" === t && "#ffffff" === e || t === e) return this.#bt;
                    ...
                    const l = o.join(","),
                        c = `g_${this.#t}_hcm_filter`,
                        h = this.#gt = this.#ft.createElementNS(a, "filter", a);
                    h.setAttribute("id", c);
                    h.setAttribute("color-interpolation-filters", "sRGB");
                    let d = this.#ft.createElementNS(a, "feComponentTransfer");
                    h.append(d);
                    this.#yt(d, "feFuncR", l);
                    this.#yt(d, "feFuncG", l);
                    this.#yt(d, "feFuncB", l);
                    const u = this.#ft.createElementNS(a, "feColorMatrix");
                    u.setAttribute("type", "matrix");
                    u.setAttribute("values", "0.2126 0.7152 0.0722 0 0 0.2126 0.7152 0.0722 0 0 0.2126 0.7152 0.0722 0 0 0 0 0 1 0");
                    h.append(u);
                    d = this.#ft.createElementNS(a, "feComponentTransfer");
                    h.append(d);
                    const getSteps = (t, e) => {
                        const s = i[t] / 255,
                            n = r[t] / 255,
                    ...
                    this.#yt(d, "feFuncR", getSteps(0, 5));
                    this.#yt(d, "feFuncG", getSteps(1, 5));
                    this.#yt(d, "feFuncB", getSteps(2, 5));
                    this.#_t.append(h);
                    this.#bt = `url(#${c})`;
                    return this.#bt
                }
                destroy(t = !1) {
                    if (!t || !this.#bt) {
                        if (this.#pt) {
                            this.#pt.parentNode.parentNode.remove();
                            this.#pt = null
                        }
                        if (this.#ut) {
                            this.#ut.clear();
            ...
            e.FontLoader = class FontLoader {
                ...
                get isSyncFontLoadingSupported() {
                    let t = !1;
                    (n.isNodeJS || "undefined" != typeof navigator && /Mozilla\/5.0.*?rv:\d+.*? Gecko/.test(navigator.userAgent)) && (t = !0);
                ...
                _queueLoadingCallback(t) {
                    const {
                        ...
                        complete: function completeRequest() {
                            (0, i.assert)(!s.done, "completeRequest() cannot be called twice.");
                            s.done = !0;
                ...
                _prepareFontLoadEvent(t, e) {
                    ...
                    const h = 1482184792;
                    let d = int32(c, 16);
                    for (s = 0, n = l.length - 3; s < n; s += 4) d = d - h + int32(l, s) | 0;
                ...
                if (0 !== r && 0 !== o) {
                    ! function genericComposeSMask(t, e, s, i, n, a, r, o, l, c, h) {
                        const d = !!a,
                            ...
                            f = d ? a[2] : 0;
                        let g;
                        g = "Luminosity" === n ? composeSMaskLuminosity : composeSMaskAlpha;
                    ...
                    }(e.context, s, r, o, e.subtype, e.backdrop, e.transferMap, n, a, e.offsetX, e.offsetY);
                    t.save();
                    t.globalAlpha = 1;
                    t.globalCompositeOperation = "source-over";
            ...
            class CanvasGraphics {
                ...
                endDrawing(t = null) {
                    ...
                    if (t) {
                        const e = this.filterFactory.addHCMFilter(t.foreground, t.background);
                        if ("none" !== e) {
                ...
                _scaleImage(t, e) {
                    ...
                    for (; r > 2 && l > 1 || o > 2 && c > 1;) {
                        ...
                        if (o > 2 && c > 1) {
                            s = c >= 16384 ? Math.floor(c / 2) - 1 || 1 : Math.ceil(c) / 2;
                            o /= c / s
                        }
                ...
                constructPath(t, e, s) {
                    ...
                    const d = (0, n.getCurrentTransform)(a),
                        ...
                        p = u ? s.slice(0) : null;
                    for (let s = 0, n = 0, f = t.length; s < f; s++) switch (0 | t[s]) {
                        ...
                        case i.OPS.curveTo:
                            ...
                            r.updateCurvePathMinMax(d, o, l, e[n], e[n + 1], e[n + 2], e[n + 3], c, h, p);
                            n += 6;
                            break;
                        case i.OPS.curveTo2:
                            o = c;
                            ...
                            r.updateCurvePathMinMax(d, o, l, c, h, e[n], e[n + 1], e[n + 2], e[n + 3], p);
                            c = e[n + 2];
                            h = e[n + 3];
                            n += 4;
                            break;
                        case i.OPS.curveTo3:
                            ...
                            r.updateCurvePathMinMax(d, o, l, e[n], e[n + 1], c, h, c, h, p);
                            n += 4;
                            break;
                ...
                stroke(t = !0) {
                    ...
                    if (this.contentVisible)
                        if ("object" == typeof s && s?.getPattern) {
                            e.save();
                            e.strokeStyle = s.getPattern(e, this, (0, n.getCurrentTransformInverse)(e), a.PathType.STROKE);
                ...
                fill(t = !0) {
                    ...
                    if (this.current.patternFill) {
                        e.save();
                        e.fillStyle = s.getPattern(e, this, (0, n.getCurrentTransformInverse)(e), a.PathType.FILL);
                        i = !0
                    }
                ...
                paintChar(t, e, s, a) {
                    ...
                    if (l.disableFontFace || p) {
                        ...
                        f(r, h);
                        a && r.setTransform(...a);
                        d !== i.TextRenderingMode.FILL && d !== i.TextRenderingMode.FILL_STROKE || r.fill();
                        d !== i.TextRenderingMode.STROKE && d !== i.TextRenderingMode.FILL_STROKE || r.stroke();
                        r.restore()
                    } else {
                        d !== i.TextRenderingMode.FILL && d !== i.TextRenderingMode.FILL_STROKE || r.fillText(t, e, s);
                        d !== i.TextRenderingMode.STROKE && d !== i.TextRenderingMode.FILL_STROKE || r.strokeText(t, e, s)
                    }
                    if (u) {
                ...
                showType3Text(t) {
                    ...
                    if (!(s.textRenderingMode === i.TextRenderingMode.INVISIBLE) && 0 !== a) {
                        ...
                        for (p = 0; p < u; ++p) {
                            ...
                            if (!u) {
                                (0, i.warn)(`Type3 character "${f.operatorListId}" is not available.`);
                                continue
                            }
                            if (this.contentVisible) {
                    ...
                    if (Array.isArray(e) && 4 === e.length) {
                        ...
                        if (r && this.annotationCanvasMap) {
                            ...
                            const [r, l] = i.Util.singularValueDecompose2dScale((0, n.getCurrentTransform)(this.ctx)), {
                                viewportScale: c
                            } = this, h = Math.ceil(a * this.outputScaleX * c), d = Math.ceil(o * this.outputScaleY * c);
                ...
                paintImageMaskXObjectGroup(t) {
                    ...
                    for (const r of t) {
                        const {
                            ...
                            height: l,
                            transform: c
                        } = r, h = this.cachedCanvases.getCanvas("maskCanvas", o, l), d = h.context;
                        d.save();
                        putBinaryImageMask(d, this.getObject(t, r));
                        d.globalCompositeOperation = "source-in";
                        d.fillStyle = i ? s.getPattern(d, this, (0, n.getCurrentTransformInverse)(e), a.PathType.FILL) : s;
                        d.fillRect(0, 0, o, l);
                        d.restore();
                        e.save();
                        e.transform(...c);
                ...
                paintInlineImageXObject(t) {
                    ...
                    const r = this._scaleImage(a, (0, n.getCurrentTransformInverse)(i));
                    i.imageSmoothingEnabled = getImageSmoothingEnabled((0, n.getCurrentTransform)(i), t.interpolate);
                    drawImageAtIntegerCoords(i, r.img, 0, 0, r.paintWidth, r.paintHeight, 0, -s, e, s);
                    this.compose();
                    this.restore()
                }
                ...
                rescaleAndStroke(t) {
                    const {
                        ...
                        lineWidth: s
                    } = this.current, [i, a] = this.getScaleForStroking();
                    e.lineWidth = s || 1;
                    if (1 === i && 1 === a) {
                        e.stroke();
                        return
                ...
                switch (e.type) {
                    case "lattice":
                        ...
                        for (a = 0; a < l; a++) {
                            let e = a * o;
                            for (let a = 0; a < c; a++, e++) {
                                drawTriangle(t, s, i[e], i[e + 1], i[e + o], n[e], n[e + 1], n[e + o]);
                                drawTriangle(t, s, i[e + o + 1], i[e + 1], i[e + o], n[e + o + 1], n[e + 1], n[e + o])
                            }
                        }
                        break;
                    case "triangles":
                        for (a = 0, r = i.length; a < r; a += 3) drawTriangle(t, s, i[a], i[a + 1], i[a + 2], n[a], n[a + 1], n[a + 2]);
                        break;
                    default:
            ...
            class MeshShadingPattern extends BaseShadingPattern {
                ...
                getPattern(t, e, s, r) {
                    applyBoundingBox(t, this._bbox);
                    let o;
                    if (r === a.SHADING) o = i.Util.singularValueDecompose2dScale((0, n.getCurrentTransform)(t));
                    else {
            ...
            class TilingPattern {
                ...
                clipBbox(t, e, s, i, a) {
                    const r = i - e,
                        o = a - s;
                    t.ctx.rect(e, s, r, o);
                    t.current.updateRectMinMax((0, n.getCurrentTransform)(t.ctx), [e, s, i, a]);
                    t.clip();
                    t.endPath()
                }
            ...
            e.Metadata = class Metadata {
                ...
                getAll() {
                    return (0, i.objectFromMap)(this.#St)
                }
                has(t) {
                    return this.#St.has(t)
                }
            }
        }, (t, e, s) => {
            Object.defineProperty(e, "__esModule", {
            ...
            class OptionalContentGroup {
                ...
                _setVisible(t, e) {
                    t !== a && (0, i.unreachable)("Internal method `_setVisible` called.");
                    this.#Et = e
                }
            }
            e.OptionalContentConfig = class OptionalContentConfig {
                ...
                constructor(t) {
                    ...
                    if (null !== t) {
                        ...
                        this.#wt = t.order;
                        for (const e of t.groups) this.#Pt.set(e.id, new OptionalContentGroup(e.name, e.intent));
                        if ("OFF" === t.baseState)
                            for (const t of this.#Pt.values()) t._setVisible(a, !1);
                        for (const e of t.on) this.#Pt.get(e)._setVisible(a, !0);
                        for (const e of t.off) this.#Pt.get(e)._setVisible(a, !1);
                        this.#Tt = this.getHash()
                    }
                }
                #kt(t) {
                    const e = t.length;
                    ...
                    for (let n = 1; n < e; n++) {
                        const e = t[n];
                        let a;
                        if (Array.isArray(e)) a = this.#kt(e);
                        else {
                            if (!this.#Pt.has(e)) {
                                (0, i.warn)(`Optional content group not found: ${e}`);
                                return !0
                            }
                            a = this.#Pt.get(e).visible
                        }
                        switch (s) {
                            case "And":
                                if (!a) return !1;
                ...
                isVisible(t) {
                    ...
                    if ("OCG" === t.type) {
                        ...
                        return this.#Pt.get(t.id).visible
                    }
                    if ("OCMD" === t.type) {
                        if (t.expression) return this.#kt(t.expression);
                        if (!t.policy || "AnyOn" === t.policy) {
                            for (const e of t.ids) {
                                ...
                                if (this.#Pt.get(e).visible) return !0
                            }
                            return !1
                        }
                        if ("AllOn" === t.policy) {
                            for (const e of t.ids) {
                                ...
                                if (!this.#Pt.get(e).visible) return !1
                            }
                            return !0
                        }
                        if ("AnyOff" === t.policy) {
                ...
                setVisibility(t, e = !0) {
                    if (this.#Pt.has(t)) {
                        this.#Pt.get(t)._setVisible(a, !!e);
                        this.#Ct = null
                    } else(0, i.warn)(`Optional content group not found: ${t}`)
                }
                get hasInitialVisibility() {
                    return this.getHash() === this.#Tt
                }
                getOrder() {
                    return this.#Pt.size ? this.#wt ? this.#wt.slice() : [...this.#Pt.keys()] : null
                }
                getGroups() {
                    return this.#Pt.size > 0 ? (0, i.objectFromMap)(this.#Pt) : null
                }
                getGroup(t) {
                    return this.#Pt.get(t) || null
                }
                getHash() {
                    if (null !== this.#Ct) return this.#Ct;
                    const t = new n.MurmurHash3_64;
                    for (const [e, s] of this.#Pt) t.update(`${e}:${s.visible}`);
                    return this.#Ct = t.hexdigest()
                }
            }
        }, (t, e, s) => {
            Object.defineProperty(e, "__esModule", {
            ...
            e.PDFDataTransportStream = class PDFDataTransportStream {
                constructor({
                    ...
                    (0, i.assert)(o, 'PDFDataTransportStream - missing required "pdfDataRangeTransport" argument.');
                    this._queuedChunks = [];
            ...
            class PDFNodeStreamFsFullReader extends BaseFullReader {
                constructor(t) {
                    ...
                    a.lstat(e, ((t, s) => {
                        if (t) {
                            "ENOENT" === t.code && (t = new i.MissingPDFException(`Missing PDF "${e}".`));
                            this._storedError = t;
                            this._headersCapability.reject(t)
                        } else {
            ...
            class PDFNodeStreamFsRangeReader extends BaseRangeReader {
                constructor(t, e, s) {
                    ...
                    this._setReadableStream(a.createReadStream(i, {
                        start: e,
                        end: s - 1
                    }))
                }
            ...
            e.getFilenameFromContentDispositionHeader = function getFilenameFromContentDispositionHeader(t) {
                ...
                function rfc2047decode(t) {
                    return !t.startsWith("=?") || /[\x00-\x19\x80-\xff]/.test(t) ? t : t.replaceAll(/=\?([\w-]*)\?([QqBb])\?((?:[^?]|\?(?!=))*)\?=/g, (function(t, e, s, i) {
                        if ("q" === s || "Q" === s) return textdecode(e, i = (i = i.replaceAll("_", " ")).replaceAll(/=([0-9a-fA-F]{2})/g, (function(t, e) {
            ...
            e.renderTextLayer = function renderTextLayer(t) {
                ...
                "visible" === a && (!r || Math.abs(r - s.scale) > 1e-15) && console.error("The `--scale-factor` CSS-variable must be set, to the same value as `viewport.scale`, either on the `container`-element itself or higher up in the DOM.");
            ...
            class AnnotationEditorLayer {
                #Ft;
                #Mt = !1;
                #Rt = this.pointerup.bind(this);
                #Dt = this.pointerdown.bind(this);
                #It = new Map;
                #Ot = !1;
                #Lt = !1;
                #Nt;
                ...
                constructor(t) {
                    ...
                    this.pageIndex = t.pageIndex;
                    this.div = t.div;
                    this.#Ft = t.accessibilityManager;
                    this.#Nt.addLayer(this)
                }
                get isEmpty() {
                    return 0 === this.#It.size
                }
                updateToolbar(t) {
                    this.#Nt.updateToolbar(t)
                }
                updateMode(t = this.#Nt.getMode()) {
                    this.#Bt();
                ...
                addInkEditorIfNeeded(t) {
                    if (!t && this.#Nt.getMode() !== i.AnnotationEditorType.INK) return;
                    if (!t)
                ...
                setEditingState(t) {
                    this.#Nt.setEditingState(t)
                }
                addCommands(t) {
                    this.#Nt.addCommands(t)
                }
                enable() {
                    this.div.style.pointerEvents = "auto";
                    for (const t of this.#It.values()) t.enableEditing()
                }
                disable() {
                    this.div.style.pointerEvents = "none";
                    for (const t of this.#It.values()) t.disableEditing();
                    this.#Bt();
                    this.isEmpty && (this.div.hidden = !0)
                }
                setActiveEditor(t) {
                    this.#Nt.getActive() !== t && this.#Nt.setActiveEditor(t)
                }
                enableClick() {
                    this.div.addEventListener("pointerdown", this.#Dt);
                    this.div.addEventListener("pointerup", this.#Rt)
                }
                disableClick() {
                    this.div.removeEventListener("pointerdown", this.#Dt);
                    this.div.removeEventListener("pointerup", this.#Rt)
                }
                attach(t) {
                    this.#It.set(t.id, t)
                }
                detach(t) {
                    this.#It.delete(t.id);
                    this.#Ft?.removePointerInTextLayer(t.contentDiv)
                }
                remove(t) {
                    this.#Nt.removeEditor(t);
                    this.detach(t);
                    ...
                    setTimeout((() => {
                        ...
                        t.div.remove();
                        t.isAttachedToDOM = !1;
                        document.activeElement === document.body && this.#Nt.focusMainContainer()
                    }), 0);
                    this.#Lt || this.addInkEditorIfNeeded(!1)
                }
                #Ut(t) {
                    if (t.parent !== this) {
                        this.attach(t);
                ...
                add(t) {
                    ...
                    t.onceAdded();
                    this.#Nt.addToAnnotationStorage(t)
                }
                moveEditorInDOM(t) {
                    this.#Ft?.moveElementInDOM(this.div, t.div, t.contentDiv, !0)
                }
                addOrRebuild(t) {
                ...
                deserialize(t) {
                    switch (t.annotationType) {
                        case i.AnnotationEditorType.FREETEXT:
                            return a.FreeTextEditor.deserialize(t, this, this.#Nt);
                        case i.AnnotationEditorType.INK:
                            return r.InkEditor.deserialize(t, this, this.#Nt)
                    }
                    return null
                }
                #jt(t) {
                ...
                setSelected(t) {
                    this.#Nt.setSelected(t)
                }
                toggleSelected(t) {
                    this.#Nt.toggleSelected(t)
                }
                isSelected(t) {
                    return this.#Nt.isSelected(t)
                }
                unselect(t) {
                    this.#Nt.unselect(t)
                }
                pointerup(t) {
                    ...
                    if (!(0 !== t.button || t.ctrlKey && e) && t.target === this.div && this.#Ot) {
                        this.#Ot = !1;
                        this.#Mt ? this.#jt(t) : this.#Mt = !0
                    }
                }
                pointerdown(t) {
                    const {
                    ...
                    this.#Ot = !0;
                    const s = this.#Nt.getActive();
                    this.#Mt = !s || s.isEmpty()
                }
                drop(t) {
                    const e = t.dataTransfer.getData("text/plain"),
                        s = this.#Nt.getEditor(e);
                    if (!s) return;
                    t.preventDefault();
                ...
                destroy() {
                    this.#Nt.getActive()?.parent === this && this.#Nt.setActiveEditor(null);
                    for (const t of this.#It.values()) {
                        this.#Ft?.removePointerInTextLayer(t.contentDiv);
                        t.setParent(null);
                        t.isAttachedToDOM = !1;
                    ...
                    this.div = null;
                    this.#It.clear();
                    this.#Nt.removeLayer(this)
                }
                #Bt() {
                    this.#Lt = !0;
                    for (const t of this.#It.values()) t.isEmpty() && t.remove();
                    this.#Lt = !1
                }
                render({
                    viewport: t
                    ...
                    for (const t of this.#Nt.getEditors(this.pageIndex)) this.add(t);
                    this.updateMode()
                }
                update({
                    viewport: t
                }) {
                    this.#Nt.commitOrRemove();
                    this.viewport = t;
            ...
            class FreeTextEditor extends a.AnnotationEditor {
                #Wt = this.editorDivBlur.bind(this);
                #Gt = this.editorDivFocus.bind(this);
                #Ht = this.editorDivInput.bind(this);
                #zt = this.editorDivKeydown.bind(this);
                #Vt;
                #Xt = "";
                #$t = `${this.id}-editor`;
                #Kt = !1;
                ...
                constructor(t) {
                    ...
                    this.#Vt = t.color || FreeTextEditor._defaultColor || a.AnnotationEditor._defaultLineColor;
                    this.#Yt = t.fontSize || FreeTextEditor._defaultFontSize
                }
                static initialize(t) {
                ...
                static get defaultPropertiesToUpdate() {
                    return [
                        ...
                        [i.AnnotationEditorParamsType.FREETEXT_COLOR, FreeTextEditor._defaultColor || a.AnnotationEditor._defaultLineColor]
                    ]
                }
                get propertiesToUpdate() {
                    return [
                        [i.AnnotationEditorParamsType.FREETEXT_SIZE, this.#Yt],
                        [i.AnnotationEditorParamsType.FREETEXT_COLOR, this.#Vt]
                    ]
                }
                #Jt(t) {
                    const setFontsize = t => {
                            this.editorDiv.style.fontSize = `calc(${t}px * var(--scale-factor))`;
                            this.translate(0, -(t - this.#Yt) * this.parentScale);
                            this.#Yt = t;
                            this.#Zt()
                        },
                        e = this.#Yt;
                ...
                #Qt(t) {
                    ...
                    this.addCommands({
                        cmd: () => {
                            this.#Vt = this.editorDiv.style.color = t
                        },
                        undo: () => {
                            this.#Vt = this.editorDiv.style.color = e
                        },
                        mustExec: !0,
                ...
                getInitialTranslation() {
                    ...
                    return [-FreeTextEditor._internalPadding * t, -(FreeTextEditor._internalPadding + this.#Yt) * t]
                }
                rebuild() {
                    super.rebuild();
                ...
                enableEditMode() {
                    if (!this.isInEditMode()) {
                        ...
                        this.editorDiv.addEventListener("keydown", this.#zt);
                        this.editorDiv.addEventListener("focus", this.#Gt);
                        this.editorDiv.addEventListener("blur", this.#Wt);
                        this.editorDiv.addEventListener("input", this.#Ht)
                    }
                }
                disableEditMode() {
                    if (this.isInEditMode()) {
                        ...
                        this.editorDiv.removeEventListener("keydown", this.#zt);
                        this.editorDiv.removeEventListener("focus", this.#Gt);
                        this.editorDiv.removeEventListener("blur", this.#Wt);
                        this.editorDiv.removeEventListener("input", this.#Ht);
                        this.div.focus({
                            preventScroll: !0
                        });
                        this.isEditing = !1;
                ...
                render() {
                    ...
                    s.fontSize = `calc(${this.#Yt}px * var(--scale-factor))`;
                    s.color = this.#Vt;
                ...
                static deserialize(t, e, s) {
                    ...
                    n.#Yt = t.fontSize;
                    n.#Vt = i.Util.makeHexColor(...t.color);
                    n.#Xt = t.value;
                    return n
                }
                serialize() {
                    ...
                    const t = FreeTextEditor._internalPadding * this.parentScale,
                        e = this.getRect(t, t),
                        s = a.AnnotationEditor._colorManager.convert(this.isAttachedToDOM ? getComputedStyle(this.editorDiv).color : this.#Vt);
                    return {
            ...
            class InkEditor extends n.AnnotationEditor {
                ...
                #se = 0;
                #ie = 0;
                #ne = this.canvasPointermove.bind(this);
                #ae = this.canvasPointerleave.bind(this);
                #re = this.canvasPointerup.bind(this);
                #oe = this.canvasPointerdown.bind(this);
                #le = !1;
                #ce = !1;
                #he = null;
                #de = null;
                ...
                static get defaultPropertiesToUpdate() {
                    return [
                        ...
                        [i.AnnotationEditorParamsType.INK_COLOR, InkEditor._defaultColor || n.AnnotationEditor._defaultLineColor],
                ...
                get propertiesToUpdate() {
                    return [
                        ...
                        [i.AnnotationEditorParamsType.INK_COLOR, this.color || InkEditor._defaultColor || n.AnnotationEditor._defaultLineColor],
                ...
                enableEditMode() {
                    if (!this.#le && null !== this.canvas) {
                        super.enableEditMode();
                        this.div.draggable = !1;
                        this.canvas.addEventListener("pointerdown", this.#oe);
                        this.canvas.addEventListener("pointerup", this.#re)
                    }
                }
                disableEditMode() {
                    if (this.isInEditMode() && null !== this.canvas) {
                        ...
                        this.canvas.removeEventListener("pointerdown", this.#oe);
                        this.canvas.removeEventListener("pointerup", this.#re)
                    }
                }
                onceAdded() {
                    this.div.draggable = !this.isEmpty()
                    ...
                    this.#fe = () => {
                        if (this.#fe) {
                            if (this.#he) {
                                ...
                                this.ctx.lineTo(...this.#he);
                                this.#he = null;
                                this.ctx.stroke()
                            }
                            window.requestAnimationFrame(this.#fe)
                        }
                    };
                    window.requestAnimationFrame(this.#fe)
                }
                ...
                #Pe(t, e) {
                    ...
                    let n;
                    if (1 !== this.currentPath.length) n = (0, a.fitCurve)(this.currentPath, 30, null);
                    else {
                        const s = [t, e];
                        n = [
                            [s, s.slice(), s.slice(), s]
                ...
                canvasPointerdown(t) {
                    if (0 === t.button && this.isInEditMode() && !this.#le) {
                        this.setInForeground();
                        "mouse" !== t.type && this.div.focus();
                        t.stopPropagation();
                        this.canvas.addEventListener("pointerleave", this.#ae);
                        this.canvas.addEventListener("pointermove", this.#ne);
                        this.#Ee(t.offsetX, t.offsetY)
                    }
                }
                canvasPointermove(t) {
                    t.stopPropagation();
                    this.#Ce(t.offsetX, t.offsetY)
                }
                canvasPointerup(t) {
                ...
                #ke(t) {
                    ...
                    this.canvas.removeEventListener("pointerleave", this.#ae);
                    this.canvas.removeEventListener("pointermove", this.#ne);
                    this.addToAnnotationStorage()
                }
                #_e() {
                ...
                setDimensions(t, e) {
                    const s = Math.round(t),
                        i = Math.round(e);
                    if (this.#ue === s && this.#pe === i) return;
                    this.#ue = s;
                    this.#pe = i;
                    this.canvas.style.visibility = "hidden";
                    if (this.#ee && Math.abs(this.#ee - t / e) > .01) {
                        e = Math.ceil(t / this.#ee);
                        this.setDims(t, e)
                    }
                    const [n, a] = this.parentDimensions;
                    this.width = t / n;
                ...
                #De(t, e, s, i) {
                    ...
                    for (const l of this.paths) {
                        ...
                        for (let n = 0, c = l.length; n < c; n++) {
                            const [c, h, d, u] = l[n], p = t * (c[0] + e) + a, f = i - t * (c[1] + s) - a, g = t * (h[0] + e) + a, m = i - t * (h[1] + s) - a, b = t * (d[0] + e) + a, A = i - t * (d[1] + s) - a, _ = t * (u[0] + e) + a, y = i - t * (u[1] + s) - a;
                            if (0 === n) {
                                r.push(p, f);
                                o.push(p, f)
                            }
                            r.push(g, m, b, A, _, y);
                            this.#Ie(p, f, g, m, b, A, _, y, 4, o)
                        }
                        n.push({
                            bezier: r,
                            points: o
                ...
                #Ie(t, e, s, i, n, a, r, o, l, c) {
                    if (this.#Oe(t, e, s, i, n, a, r, o)) c.push(r, o);
                    else {
                        for (let h = 1; h < l - 1; h++) {
                            const d = h / l,
                                u = 1 - d;
                ...
                #Re() {
                    return this.#le ? Math.ceil(this.thickness * this.parentScale) : 0
                }
                #be(t = !1) {
                    ...
                    const e = this.#Le(),
                        s = this.#Re();
                    this.#ie = Math.max(o, e[2] - e[0]);
                    this.#se = Math.max(o, e[3] - e[1]);
                    const i = Math.ceil(s + this.#ie * this.scaleFactor),
                        n = Math.ceil(s + this.#se * this.scaleFactor),
                ...
                #Fe() {
                    ...
                    if (this.#ee >= 1) {
                        t.minHeight = "16px";
                        t.minWidth = `${Math.round(this.#ee*o)}px`
                    } else {
                        t.minWidth = "16px";
                        t.minHeight = `${Math.round(o/this.#ee)}px`
                    }
                }
                static deserialize(t, e, s) {
                    const n = super.deserialize(t, e, s);
                    ...
                    n.opacity = t.opacity;
                    const [a, r] = n.pageDimensions, l = n.width * a, c = n.height * r, h = n.parentScale, d = t.thickness / 2;
                    n.#ee = l / c;
                    n.#le = !0;
                    n.#ue = Math.round(l);
                    n.#pe = Math.round(c);
                    ...
                    const u = n.#Le();
                    n.#ie = Math.max(o, u[2] - u[0]);
                    n.#se = Math.max(o, u[3] - u[1]);
                    n.#Me(l, c);
                    return n
                }
                serialize() {
                    ...
                    const t = this.getRect(0, 0),
                        ...
                        s = n.AnnotationEditor._colorManager.convert(this.ctx.strokeStyle);
                    return {
                        annotationType: i.AnnotationEditorType.INK,
                        color: s,
                        thickness: this.thickness,
                        opacity: this.opacity,
                        paths: this.#De(this.scaleFactor / this.parentScale, this.translationX, this.translationY, e),
                        pageIndex: this.pageIndex,
                        rect: t,
                        rotation: this.rotation
                    }
            ...
            function fitCubic(t, e, s, i, n) {
                ...
                if (2 === t.length) {
                    ...
                    return [a = [t[0], maths.addArrays(t[0], maths.mulItems(e, m)), maths.addArrays(t[1], maths.mulItems(s, m)), t[1]]]
                }
                ...
                return g = (g = g.concat(fitCubic(t.slice(0, h + 1), e, p, i, n))).concat(fitCubic(t.slice(h), f, s, i, n))
            }

            function generateAndReport(t, e, s, i, n, a) {
                var r, o, l;
                r = function generateBezier(t, e, s, i) {
                    var n, a, r, o, l, c, h, d, u, p, f, g, m, b, A, _, y, v = t[0],
                        S = t[t.length - 1];
                    n = [v, null, null, S];
                ...
                [o, l] = function computeMaxError(t, e, s) {
                    ...
                    for (o = 0, l = t.length; o < l; o++) {
                        c = t[o];
                        h = find_t(e, s[o], d, 10);
                        if ((i = (r = maths.subtract(bezier.q(e, h), c))[0] * r[0] + r[1] * r[1]) > n) {
                            n = i;
                            a = o
                        }
                    }
            ...
            function newtonRaphsonRootFind(t, e, s) {
                var i = maths.subtract(bezier.q(t, s), e),
                    ...
                    r = maths.sum(maths.squareItems(n)) + 2 * maths.mulMatrix(i, bezier.qprimeprime(t, s));
                return 0 === r ? s : s - a / r
            }
            ...
            class bezier {
                static q(t, e) {
                    ...
                    return maths.addArrays(maths.addArrays(i, n), maths.addArrays(a, r))
                }
                static qprime(t, e) {
                    var s = 1 - e,
            ...
            t.exports = function fitCurve(t, e, s) {
                ...
                if ((t = t.filter(((e, s) => 0 === s || !e.every(((e, i) => e === t[s - 1][i]))))).length < 2) return [];
                const i = t.length,
            ...
            class AnnotationElement {
                ...
                _createContainer(t = !1) {
                    ...
                    const {
                        ...
                        width: h,
                        height: d
                    } = getRectDims(e.rect), u = i.Util.normalizeRect([e.rect[0], s.view[3] - e.rect[1] + s.view[1], e.rect[2], s.view[3] - e.rect[3] + s.view[1]]);
                    if (!t && e.borderStyle.width > 0) {
                        ...
                        n ? a.style.borderColor = i.Util.makeHexColor(0 | n[0], 0 | n[1], 0 | n[2]) : a.style.borderWidth = 0
                    }
                ...
                _createPopup(t, e) {
                    ...
                    if (!t) {
                        (t = document.createElement("div")).classList.add("popupTriggerArea");
                        s.append(t)
                    }
                ...
                render() {
                    ...
                    if (this.renderForms) {
                        ...
                        s.addEventListener("input", (i => {
                            ...
                            this.setPropertyOnSiblings(s, "value", i.target.value, "value")
                        }));
                            ...
                            s.addEventListener("updatefromsandbox", (s => {
                                const i = {
                                    ...
                                    formattedValue(s) {
                                        ...
                                        r.formattedValue = i;
                                        null != i && s.target !== document.activeElement && (s.target.value = i);
                                        t.setValue(e, {
                                            formattedValue: i
                                        })
                                    },
            ...
            class ChoiceWidgetAnnotationElement extends WidgetAnnotationElement {
                ...
                render() {
                            ...
                            const n = {
                                ...
                                insert(s) {
                                    const {
                                        ...
                                        displayValue: a,
                                        exportValue: o
                                    } = s.detail.insert, l = i.children[n], c = document.createElement("option");
                                    c.textContent = a;
                                    c.value = o;
                    ...
                    } else i.addEventListener("input", (function(s) {
                        t.setValue(e, {
                            value: getValue(!0)
                        })
                    }));
            ...
            class PopupAnnotationElement extends AnnotationElement {
                ...
                render() {
                    ...
                    const e = new PopupElement({
                        ...
                        s = this.page,
                        n = i.Util.normalizeRect([this.data.parentRect[0], s.view[3] - this.data.parentRect[1] + s.view[1], this.data.parentRect[2], s.view[3] - this.data.parentRect[3] + s.view[1]]),
                ...
                render() {
                    ...
                    if (s) {
                        const t = .7 * (255 - s[0]) + s[0],
                            n = .7 * (255 - s[1]) + s[1],
                            a = .7 * (255 - s[2]) + s[2];
                        e.style.backgroundColor = i.Util.makeHexColor(0 | t, 0 | n, 0 | a)
                    }
                    ...
                    for (const t of e) {
                        ...
                        if (Array.isArray(n))
                            for (const e of n) {
                                ...
                                n.style.zIndex = c++;
                                e instanceof PopupAnnotationElement ? s.prepend(n) : AnnotationLayer.#je(n, t.id, s, o)
                            }
                    }
                    this.#Ue(s, t.annotationCanvasMap)
                }
                static update(t) {
                    const {
                        annotationCanvasMap: e,
                ...
                static #Ue(t, e) {
                    if (e) {
                        for (const [s, i] of e) {
                            ...
                            n ? "CANVAS" === n.nodeName ? n.replaceWith(i) : n.before(i) : e.append(i)
                        }
                        e.clear()
                    }
                }
            ...
            e.XfaLayer = class XfaLayer {
                static setupStorage(t, e, s, i, n) {
                    ...
                    switch (s.name) {
                        ...
                        case "select":
                            if (null !== a.value)
                                for (const t of s.children) t.attributes.value === a.value && (t.attributes.selected = !0);
                            t.addEventListener("input", (t => {
            ...
            e.SVGGraphics = r; {
                ...
                function opListToTree(t) {
                    ...
                    const s = [];
                    for (const i of t)
                        if ("save" !== i.fn) "restore" === i.fn ? e = s.pop() : e.push(i);
                        else {
                            e.push({
                                fnId: 92,
                                fn: "group",
                ...
                e.SVGGraphics = r = class {
                    ...
                    showText(t) {
                        ...
                        const b = e.textRenderingMode & n.TextRenderingMode.FILL_STROKE_MASK;
                        if (b === n.TextRenderingMode.FILL || b === n.TextRenderingMode.FILL_STROKE) {
                        ...
                        if (b === n.TextRenderingMode.STROKE || b === n.TextRenderingMode.FILL_STROKE) {
                    ...
                    _makeTilingPattern(t) {
                        const e = t[1],
                            ...
                            d = t[7],
                            u = "shading" + g++,
                            [p, f, m, b] = n.Util.normalizeRect([...n.Util.applyTransform([a, r], i), ...n.Util.applyTransform([o, l], i)]),
                        ...
                        const x = this.svg,
                            ...
                            T = this.svgFactory.create(m - p, b - f);
                        this.svg = T;
                    ...
                    constructPath(t, e) {
                        ...
                        for (const s of t) switch (0 | s) {
                            case n.OPS.rectangle:
                                ...
                                const t = i + e[o++],
                                    s = a + e[o++];
                                r.push("M", pf(i), pf(a), "L", pf(t), pf(a), "L", pf(t), pf(s), "L", pf(i), pf(s), "Z");
                                break;
                            case n.OPS.moveTo:
                                i = e[o++];
                                a = e[o++];
                            ...
                            case n.OPS.curveTo:
                                i = e[o + 4];
                                a = e[o + 5];
                                r.push("C", pf(e[o]), pf(e[o + 1]), pf(e[o + 2]), pf(e[o + 3]), pf(i), pf(a));
                                o += 6;
                                break;
                            case n.OPS.curveTo2:
                                r.push("C", pf(i), pf(a), pf(e[o]), pf(e[o + 1]), pf(e[o + 2]), pf(e[o + 3]));
                                i = e[o + 2];
                                a = e[o + 3];
                                o += 4;
                                break;
                            case n.OPS.curveTo3:
                                i = e[o + 2];
                                a = e[o + 3];
                                r.push("C", pf(e[o]), pf(e[o + 1]), pf(i), pf(a), pf(i), pf(a));
                                o += 4;
                                break;
                            case n.OPS.closePath:
                                r.push("Z")
                        ...
                        r = r.join(" ");
                        if (s.path && t.length > 0 && t[0] !== n.OPS.rectangle && t[0] !== n.OPS.moveTo) r = s.path.getAttributeNS(null, "d") + r;
                        else {
                    ...
                    paintInlineImageXObject(t, e) {
                        ...
                        r.setAttributeNS(null, "transform", `scale(${pf(1/s)} ${pf(-1/i)})`);
