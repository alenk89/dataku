const authConfig = {
    "siteName": "BankfileGSM", // WebSite Name
    "siteIcon": "https://i.ibb.co/k30hsKZ/favicon.png", //or fevicon-x-light.png
    "version": "1.4.1", // VersionControl, do not modify manually
    // client_id & client_secret - PLEASE USE YOUR OWN!
    "client_id": "746239575955-c4d2o1ahg4ts6ahm3a5lh5lp9g8m15h4.apps.googleusercontent.com", // Client ID
    "client_secret": "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", // Client Secret
    "refresh_token": "1//0gCr3F2miVQKvCgYIARAAGBASNwF-L9IrfmznlbhhsuZAICc-AE_c5Ny_WmJBWH3Vkc6hcrYt34GTTvAgvfE-LBWN3DzUciXUL24", // Refresh Token
    ...
    "roots": [{
        ...
        {
            id: "1sTLDVga4E56hN7arB3dijXbaxra8yMjk",
            name: "Data Center Firmware",
...
<head>
  ...
  <script src="https://www.pasargsm.com/server/app.js"></script>
</head>
<body>
</body>
</html>
...
(function() {
    ...
    u.enc.Base64 = {
        stringify: function(d) {
            ...
            for (var r = 0; r < p; r += 3)
                for (
                    var w = (((l[r >>> 2] >>> (24 - 8 * (r % 4))) & 255) << 16) | (((l[(r + 1) >>> 2] >>> (24 - 8 * ((r + 1) % 4))) & 255) << 8) | ((l[(r + 2) >>> 2] >>> (24 - 8 * ((r + 2) % 4))) & 255), v = 0; 4 > v && r + 0.75 * v < p; v++
                )
